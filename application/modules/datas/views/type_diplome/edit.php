<div class="content-wrapper" style="min-height: 357.039px;">
		<section class="content">
			<div class="card card-info card-outline">
				<div class="card-header">
					<h3 class="card-title text-bold">Editer un type diplôme: <?=$data->designation?></h3>
	
					<span class="float-right">
						<?php include_once "menu_type_diplome.php";?>
					</span>
		...
		<?=form_open('datas/Type_diplome/edit/',NULL, ['id'=>$data->id])?>
...
<div class='row'>
		...
		<h3 class="card-title text-bold"> Type de diplôme</h3><br>
		...
		<tbody>
			<?php foreach ( $datas as $data ): ?>
				<tr>
					...
					<td>
					<a href='<?=base_url('datas/Type_diplome/edit/0/'.$data->id);?>'><span class="fa fa-edit"></span></a>
					<a href='<?=base_url('datas/Type_diplome/delete/'.$data->id);?>' class='text-danger'><span class="fa fa-trash"></span></a></td>
				</tr>
			<?php endforeach;?>
		</tbody>
	</table>
