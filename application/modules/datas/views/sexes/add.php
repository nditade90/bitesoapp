    ...
    <section class="content">
		...
		<div class="row">
		<div class="col-md-4">
		<h3 class="card-title text-bold">Ajouter une sexe</h3><br>
		<?=form_open('datas/Sexes/index')?>
		

			<div class='form-group'><label>code</label>
			<?=form_input('code_sexe',set_value('code_sexe'),"class='form-control' ,placeholder='Code '")?>
			<?php echo form_error('code_sexe','<div class="text-danger">', '</div>'); ?></div>

			<div class='form-group'><label>Sexe</label>
			<?=form_input('nom_sexe',set_value('nom_sexe'),"class='form-control' ,placeholder='Sexe'")?>
