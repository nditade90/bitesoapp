    ...
    <section class="content">
        <div class="card card-info card-outline">
            <div class="card-header">
                <h3 class="card-title text-bold">Ajouter un type de stage</h3>
		...
		<?=form_open('datas/Type_stages/index')?>
			...
			<div class='form-group'>
				...
				<?=form_textarea('description',set_value('description'),"class='form-control' placeholder='description'")?>
