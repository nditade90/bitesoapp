    ...
    <section class="content">
        <div class="card card-info card-outline">
            <div class="card-header">
                <h3 class="card-title text-bold">Ajouter une catégorie cellule</h3>
		...
		<?=form_open('datas/Categories_cellules/index')?>
		

			<div class='form-group'><label>Cellule</label>
			<?=form_dropdown('cellule_id',$this->My_model->multi_dropdown('gr_cellules',['id','designation']),set_value('cellule_id'),"class='form-control', id='cellule_id'")?>
			<?php echo form_error('cellule_id','<div class="text-danger">', '</div>'); ?></div>
