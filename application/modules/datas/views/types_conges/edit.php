	<div class="content-wrapper" style="min-height: 357.039px;">
		<section class="content">
			<div class="card card-info card-outline">
				<div class="card-header">
					<h3 class="card-title text-bold">Editer un type de congé</h3>
		...
		<?=form_open('datas/Types_conges/edit/',NULL, ['id_type_conge'=>$data->id_type_conge])?>
			...
			<?=form_input('nb_jour',set_value('nb_jour',$data->nb_jour),"class='form-control' placeholder='nb_jour'")?>
