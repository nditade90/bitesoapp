<div class="content-wrapper" style="min-height: 357.039px;">
		<section class="content">
			<div class="card card-info card-outline">
				<div class="card-header">
					<h3 class="card-title text-bold">Editer un établissement </h3>
		...
		<?=form_open('datas/Etablissements/edit/',NULL, ['id'=>$data->id])?>
			...
			<div class='form-group'>
				<label>Lieu</label>
				<?=form_input('lieu',set_value('lieu',$data->lieu),"class='form-control' placeholder='lieu'")?>
				<?php echo form_error('lieu','<div class="text-danger">', '</div>'); ?></div>

			<div class='form-group'>
				<label>Pays</label>
				<?=form_dropdown('pays_id',$this->My_model->multi_dropdown('gr_pays',['id_pays','nom_pays']),set_value('pays_id', $data->pays_id),"class='form-control'")?>
