<div class="content-wrapper" style="min-height: 357.039px;">
		<section class="content">
			...
			<?=form_input('code_ethnie',set_value('code_ethnie', $data->code_ethnie),"class='form-control' ,placeholder='Code'")?>
			<?php echo form_error('code_ethnie','<div class="text-danger">', '</div>'); ?></div>

			<div class='form-group'><label>Ethnie</label>
			<?=form_input('nom_ethnie',set_value('nom_ethnie', $data->nom_ethnie),"class='form-control' ,placeholder='Nom de l\'ethinie '")?>
