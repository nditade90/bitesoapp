	...
	<?php include VIEWPATH."menu_secondary/menu_mouvement.php"; ?>
        ...
        <div class="card card-info card-outline">
			<div class="card-header">
				<h3 class="card-title text-uppercase">Ajouter une exemption de service</h3>
				<span class="float-right"> 
					<a class='btn btn-info btn-sm' href="<?php echo base_url('mouvement/Exemptions_service/add')?>"><i class='fa fa-file'></i>
						<span class='d-none d-sm-inline'>&nbsp;Nouveau</span>
					</a>

					<a class='btn btn-primary btn-sm' href="<?php echo base_url('mouvement/Exemptions_service/index')?>"><i class='fa fa-list'></i>
		...
		<?=form_open('mouvement/Exemptions_service/add')?>
		...
		<div class="row">
			...
			<div class='col-md-3'>
				...
				<div class="input-group date" id="date_debut" data-target-input="nearest">
					<?=form_input('date_debut',set_value('date_debut', date('Y-m-d')),"class='form-control datetimepicker-input', id='date_debut'")?>
			...
			<div class='col-md-3'>
				...
				<div class="input-group date" id="date_fin" data-target-input="nearest">
					<?=form_input('date_fin',set_value('date_fin', date('Y-m-d')),"class='form-control datetimepicker-input', id='date_fin'")?>
			...
			<div class='col-md-3'><label>Nombre de jours</label>
			<?=form_input('nb_jours',set_value('nb_jours'),"class='form-control' placeholder='nb_jours'")?>
						<?php echo form_error('nb_jours','<div class="text-danger">', '</div>'); ?></div>
