<div class="content-wrapper" style="min-height: 357.039px;">
		...
		<?php include VIEWPATH."menu_secondary/menu_mouvement.php"; ?>
			...
			<div class="card-header">
				<h3 class="card-title text-uppercase">Editer une Formation / stage</h3>
				<span class="float-right"> 
					<a class='btn btn-info btn-sm' href="<?php echo base_url('mouvement/Formations_stages/add/')?>"><i class='fa fa-file'></i>
						<span class='d-none d-sm-inline'>&nbsp;Nouveau</span>
					</a>

					<a class='btn btn-primary btn-sm' href="<?php echo base_url('mouvement/Formations_stages/index')?>"><i class='fa fa-list'></i>
			...
			<div class="card-body">
			<?=form_open('mouvement/Formations_stages/edit/',NULL, ['id_formation_stage'=>$data->id_formation_stage])?>
			...
			<div class='col-md-3'>
				<label>Stage</label>
				<?=form_dropdown('id_stage',$this->My_model->multi_dropdown('mv_stages',['id_stage','titre_stage']),set_value('id_stage,',$data->id_stage),"class='form-control' placeholder='id_stage'")?>
				<?php echo form_error('id_stage','<div class="text-danger">', '</div>'); ?>
			</div>			

			<div class='col-md-3'>
				<label>Dilome obtenu</label>
			...
			<div class='col-md-3'>
				...
				<div class="input-group date" id="date_debut" data-target-input="nearest">
					<?=form_input('date_debut',set_value('date_debut', $data->date_debut),"class='form-control datetimepicker-input', id='date_debut',placeholder='Date de debut'")?>
			...
			<div class='col-md-3'>
				...
				<?=form_input('ref_stage',set_value('ref_stage',$data->ref_stage),"class='form-control' placeholder='ref_stage'")?>
				<?php echo form_error('ref_stage','<div class="text-danger">', '</div>'); ?>
			</div>

			<div class='col-md-3'>
				<label>Nombre du mois</label>
				<?=form_input('nb_mois',set_value('nb_mois',$data->nb_mois),"class='form-control' placeholder='nb_mois'")?>
			...
			<div class='col-md-3'>
				...
				<?=form_dropdown('id_specialite',$this->My_model->multi_dropdown('gr_specialites',['id_specialite', 'nom_specialite']),set_value('id_specialite,',$data->id_specialite),"class='form-control' placeholder='id_specialite'")?>
				<?php echo form_error('id_specialite','<div class="text-danger">', '</div>'); ?>
			</div>

			<div class='col-md-3'>
				<label>Montant prime</label>
				<?=form_input('montant_prime',set_value('montant_prime',$data->montant_prime),"class='form-control' placeholder='montant_prime'")?>
			...
			<div class='col-md-3'>
				...
				<div class="input-group date" id="date_specialite" data-target-input="nearest">
					<?=form_input('date_specialite',set_value('date_specialite', $data->date_specialite),"class='form-control datetimepicker-input', id='date_specialite',placeholder='Date de spécialité'")?>
			...
			<div class='col-md-3'>
				...
				<?=form_input('ref_specialite',set_value('ref_specialite',$data->ref_specialite),"class='form-control' placeholder='ref_specialite'")?>
