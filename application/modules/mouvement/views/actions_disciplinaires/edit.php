		...
		<?php include VIEWPATH."menu_secondary/menu_mouvement.php"; ?>
			<div class="card card-info card-outline">
				<div class="card-header">
					...
					<a class='btn btn-info btn-sm' href="<?php echo base_url('mouvement/Actions_disciplinaires/add')?>"><i class='fa fa-file'></i>
						<span class='d-none d-sm-inline'>&nbsp;Nouveau</span>
					</a>

					<a class='btn btn-primary btn-sm' href="<?php echo base_url('mouvement/Actions_disciplinaires/index')?>"><i class='fa fa-list'></i>
			...
			<input type="hidden" name="id_identification" value="<?=$id_identification?>">
				...
				<div class='col-md-3'>
					...
					<div class="input-group date" id="date_ouverture" data-target-input="nearest">
						<?=form_input('date_ouverture',set_value('date_ouverture', $data->date_ouverture),"class='form-control datetimepicker-input', id='date_ouverture' placeholder='date_ouverture'")?>
				...
				<div class='col-md-3'>
					...
					<?=form_dropdown('id_type_punition',$this->My_model->multi_dropdown('mv_types_punition',['id_type_punition','nom_type_punition']),set_value('id_type_punition,',$data->id_type_punition),"class='form-control' placeholder='id_type_punition'")?>
					<?php echo form_error('id_type_punition','<div class="text-danger">', '</div>'); ?>
				</div>

				<div class='col-md-3'>
					<label>Nombre de jours</label>
					<?=form_input('nb_jours_punition',set_value('nb_jours_punition',$data->nb_jours_punition),"class='form-control' placeholder='nb_jours_punition'")?>
				...
				<div class='col-md-3'>
					...
					<div class="input-group date" id="date_cloture" data-target-input="nearest">
						<?=form_input('date_cloture',set_value('date_cloture', $data->date_cloture),"class='form-control datetimepicker-input', id='date_cloture' placeholder='date_cloture'")?>
				...
				<div class='col-md-3'>
					<label>Ref. de cloture</label>
					<?=form_input('ref_cloture',set_value('ref_cloture',$data->ref_cloture),"class='form-control' placeholder='ref_cloture'")?>
				...
				<div class='col-md-3'>
					...
					<div class="input-group date" id="date_levee" data-target-input="nearest">
						<?=form_input('date_levee',set_value('date_levee', $data->date_levee),"class='form-control datetimepicker-input', id='date_levee' placeholder='date_levee'")?>
				...
				<div class='col-md-3'>
					...
					<?=form_input('autorite_decision',set_value('autorite_decision',$data->autorite_decision),"class='form-control' placeholder='autorite_decision'")?>
					<?php echo form_error('autorite_decision','<div class="text-danger">', '</div>'); ?>
				</div>

				<div class='col-md-3'>
					<label>Ref. de levée</label>
					<?=form_input('ref_levee',set_value('ref_levee',$data->ref_levee),"class='form-control' placeholder='ref_levee'")?>
			...
			<div class='row' style='margin:6px'>
				<?=form_submit('','Enregistrer les changements','class="btn btn-primary"')?>
			<?=form_close()?>
			</div>
		</section>
	</div>