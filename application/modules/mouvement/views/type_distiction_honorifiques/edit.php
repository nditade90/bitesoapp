<div class="content-wrapper" style="min-height: 357.039px;">
		...
		<?=form_open('mouvement/Type_distiction_honorifiques/edit/',NULL, ['id_type_distiction'=>$data->id_type_distiction])?>
			...
			<?=form_input('type_distiction',set_value('type_distiction',$data->type_distiction),"class='form-control' placeholder='type_distiction'")?>
...
<div class='row'>
		...
		<h3 class="card-title text-bold"> Types distiction honorifiques</h3><br>

<?php echo form_label('','hidden')?>
	<table class='table table-striped table-bordered'>
		<thead>
			<th>#</th>
			<th>Type distiction</th><th>Options</th>
		</thead>
		<tbody>
