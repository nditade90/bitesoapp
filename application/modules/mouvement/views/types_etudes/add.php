    ...
    <section class="content">
		...
		<div class="row">
		<div class="col-md-4">
		<h3 class="card-title text-bold">Ajouter un type d'etude</h3><br>
		<?=form_open('mouvement/Types_etudes/index')?>
		

			<div class='form-group'><label>Type d'etude</label>
...
<div class='row'>
		...
		<h3 class="card-title text-bold"> Types d'etudes</h3><br>
