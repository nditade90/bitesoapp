    ...
    <section class="content">
		...
		<?=form_open('mouvement/Types_punition/index')?>
			...
			<?=form_input('code_type_punition',set_value('code_type_punition'),"class='form-control' placeholder='code_type_punition'")?>
			<?php echo form_error('code_type_punition','<div class="text-danger">', '</div>'); ?></div>

			<div class='form-group'><label>Nom du type</label>
			<?=form_input('nom_type_punition',set_value('nom_type_punition'),"class='form-control' placeholder='nom_type_punition'")?>
