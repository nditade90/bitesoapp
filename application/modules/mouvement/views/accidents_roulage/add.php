	...
	<?php include VIEWPATH."menu_secondary/menu_mouvement.php"; ?>
        <div class="card card-info card-outline">
			<div class="card-header">
				<h3 class="card-title text-uppercase">Ajouter un accident de roulage</h3>
				<span class="float-right"> 
					<a class='btn btn-info btn-sm' href="<?php echo base_url('mouvement/Accidents_roulage/add')?>"><i class='fa fa-file'></i>
						<span class='d-none d-sm-inline'>&nbsp;Retour sur détail</span>
					</a>

					<a class='btn btn-primary btn-sm' href="<?php echo base_url('mouvement/Accidents_roulage/index')?>"><i class='fa fa-list'></i>
		...
		<?=form_open('mouvement/Accidents_roulage/add')?>
		...
		<div class="row">
			...
			<div class='col-md-3'>
				...
				<?=form_input('responsable',set_value('responsable'),"class='form-control' placeholder='responsable'")?>
				<?php echo form_error('responsable','<div class="text-danger">', '</div>'); ?>
			</div>			

			<div class='col-md-3'>
				<label>Observation</label>
				<?=form_input('observation',set_value('observation'),"class='form-control' placeholder='observation'")?>
				<?php echo form_error('observation','<div class="text-danger">', '</div>'); ?>
			</div>

			<div class='col-md-3'>
				<label>Chargé de dégât</label>
				<?=form_input('degat_charge',set_value('degat_charge'),"class='form-control' placeholder='degat_charge'")?>
				<?php echo form_error('degat_charge','<div class="text-danger">', '</div>'); ?>
			</div>
			
			<div class='col-md-3'>
				<label>Cause de dégât</label>
				<?=form_input('degat_cause',set_value('degat_cause'),"class='form-control' placeholder='degat_cause'")?>
