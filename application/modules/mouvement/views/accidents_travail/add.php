        ...
        <div class="card card-info card-outline">
			<div class="card-header">
				...
				<span class="float-right"> 
					<a class='btn btn-info btn-sm' href="<?php echo base_url('mouvement/Accidents_travail/add')?>"><i class='fa fa-file'></i>
						<span class='d-none d-sm-inline'>&nbsp;Nouveau</span>
					</a>

					<a class='btn btn-primary btn-sm' href="<?php echo base_url('mouvement/Accidents_travail/index')?>"><i class='fa fa-list'></i>
