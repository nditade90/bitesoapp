	...
	<?php include VIEWPATH."menu_secondary/menu_mouvement.php"; ?>
        ...
        <div class="card card-info-cust card-outline">
			<div class="card-header">
				<h3 class="card-title text-uppercase">Enregistrer une absence</h3>
				<span class="float-right"> 
					<a class='btn btn-primary-cust btn-sm' href="<?php echo base_url('mouvement/Absences/add/')?>"><i class='fa fa-file'></i>
						<span class='d-none d-sm-inline'>&nbsp;Nouvelle</span>
					</a>

					<a class='btn btn-sm' href="<?php echo base_url('gr/Fiche_identification/index')?>"><i class='fa fa-list'></i>
		...
		<div class="card-body">
				...
				<?=form_close()?>
				<hr />
			<?=form_open('mouvement/Absences/add')?>
			...
			<div class='col-md-3'>
				...
				<div class="input-group date" id="date_fin" data-target-input="nearest">
					<?=form_input('date_fin',set_value('date_fin', date('Y-m-d')),"class='form-control datetimepicker-input', id='date_fin',placeholder='Date de début'")?>
			...
			<div class='col-md-3'>
				...
				<?=form_input('nb_heures',set_value('nb_heures'),"class='form-control' placeholder='nb_heures'")?>
				<?php echo form_error('nb_heures','<div class="text-danger">', '</div>'); ?>
			</div>

			<div class='col-md-3'>
				<label>Est justifie?</label>
				<?=form_input('est_justifie',set_value('est_justifie'),"class='form-control' placeholder='est_justifie'")?>
