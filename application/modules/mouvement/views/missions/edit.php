		...
		<section class="content">
			<div class="card card-info card-outline">
				<div class="card-header">
					<h3 class="card-title text-bold">Editer une mission </h3>
			...
			<?=form_open('mouvement/Missions/edit/',NULL, ['id_mission'=>$data->id_mission])?>
			...
			<div class='col-md-3'>
				...
				<?=form_dropdown('id_type_mission',$this->My_model->multi_dropdown('mv_types_missions',['id_type_mission','type_mission']),set_value('id_type_mission',$data->id_type_mission),"class='form-control' placeholder='id_type_mission'")?>
				<?php echo form_error('id_type_mission','<div class="text-danger">', '</div>'); ?>
			</div>

			<div class='col-md-3'>
				<label>Contingent</label>
				<?=form_input('contingent',set_value('contingent',$data->contingent),"class='form-control' placeholder='contingent'")?>
				<?php echo form_error('contingent','<div class="text-danger">', '</div>'); ?>
			</div>

			<div class='col-md-3'>
				<label>Bataillon</label>
				<?=form_input('bataillon',set_value('bataillon',$data->bataillon),"class='form-control' placeholder='bataillon'")?>
				<?php echo form_error('bataillon','<div class="text-danger">', '</div>'); ?>
			</div>

			<div class='col-md-3'>
				<label>Fonction</label>
				<?=form_input('fonction',set_value('fonction',$data->fonction),"class='form-control' placeholder='fonction'")?>
			...
			<div class='col-md-3'>
				...
				<div class="input-group date" id="date_debut" data-target-input="nearest">
					<?=form_input('date_debut',set_value('date_debut', $data->date_debut),"class='form-control datetimepicker-input', id='date_debut',placeholder='Date debut'")?>
