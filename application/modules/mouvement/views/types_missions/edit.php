<div class="content-wrapper" style="min-height: 357.039px;">
		<section class="content">
			...
			<div class="row">
			<div class="col-md-4">
			<h3 class="card-title text-bold">Editer un type de mission: <?=$data->type_mission?></h3><br>
		<?=form_open('mouvement/Types_missions/edit/',NULL, ['id_type_mission'=>$data->id_type_mission])?>

			<div class='form-group'><label>Type de mission</label><?php echo form_error('type_mission'); ?>
