        ...
        <div class="card card-info-cust card-outline">
			<div class="card-header">
				...
				<span class="float-right"> 
					<a class='btn btn-primary-cust btn-sm' href="<?php echo base_url('gr/Fiche_carrieres/add/')?>"><i class='fa fa-file'></i>
						<span class='d-none d-sm-inline'>&nbsp;Nouveau</span>
					</a>

					<a class='btn btn-sm' href="<?php echo base_url('gr/Fiche_carrieres/index')?>"><i class='fa fa-list'></i>
		...
		<div class="card-body">
			...
			<div class="col-md-12">		 	
				...
				<div class="row">
					...
					<div class='col-md-3'><label>Code Indemnite de risque des candidats</label>
