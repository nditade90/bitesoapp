    ...
    <section class="content">
		...
		<div class="row">
		<div class="col-md-4">
		<h3 class="card-title text-bold">Ajouter d'un groupe sanguin</h3><br>
		<?=form_open('gr/Groupes_sanguin/index')?>
		

			<div class='form-group'><label>Nom du groupe sanguin</label>
			<?=form_input('nom_gpe_sanguin',set_value('nom_gpe_sanguin'),"class='form-control' placeholder='nom'")?>
		...
		<tbody>
			<?php foreach ( $datas as $data ): ?>
				<tr>
					...
					<td><a href='<?=base_url('gr/Groupes_sanguin/view/'.$data->id_gpe_sanguin);?>'><span class="fa fa-eye"></span></a>
					<a href='<?=base_url('gr/Groupes_sanguin/edit/0/'.$data->id_gpe_sanguin);?>'><span class="fa fa-edit"></span></a>
					<a href='<?=base_url('gr/Groupes_sanguin/delete/'.$data->id_gpe_sanguin);?>' class='text-danger'><span class="fa fa-trash"></span></a></td>
				</tr>
			<?php endforeach;?>
		</tbody>
	</table>
