        ...
        <div class="card card-info-cust card-outline">
        	<div class="card-header">
				...
				<span class="float-right"> 
					<a class='btn btn-primary-cust btn-sm' href="<?php echo base_url('gr/Ayants_droit/add')?>"><i class='fa fa-file'></i>
						<span class='d-none d-sm-inline'>&nbsp;Nouveau</span>
					</a> 
					<a class='btn  btn-sm' href="<?php echo base_url('gr/Ayants_droit/index')?>"><i class='fa fa-list'></i>
			...
			<div class="row">
					...
					<div class='col-md-3' >
						...
						<div class="input-group date" id="date_divorce" data-target-input="nearest">
							...
							<div class="input-group-append" data-target="#date_divorce" data-toggle="datetimepicker">
								<div class="input-group-text"><i class="fa fa-calendar"></i></div>
							</div>
						</div>
					...
					<div class='col-md-3'>
						...
						<div class="input-group date" id="date_deces" data-target-input="nearest">
						<?=form_input('date_deces',set_value('date_deces'),"class='form-control datetimepicker-input', id='date_deces' placeholder='date_deces'")?>
						<div class="input-group-append" data-target="#date_deces" data-toggle="datetimepicker">
							<div class="input-group-text"><i class="fa fa-calendar"></i></div>
						</div>
