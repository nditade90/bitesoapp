<div class="content-wrapper" style="min-height: 357.039px;">
		<section class="content">
			...
			<div class='form-group'><label>Code</label><?php echo form_error('code_categorie'); ?>
			<?=form_input('code_categorie',set_value('code_categorie',$data->code_categorie),"class='form-control' ,placeholder='code_categorie'")?>
			<?php echo form_error('code_categorie','<div class="text-danger">', '</div>'); ?></div>

			<div class='form-group'><label>nom_categorie</label><?php echo form_error('nom_categorie'); ?>
