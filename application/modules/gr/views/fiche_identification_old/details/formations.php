...
<span class="float-right"> 
    <a class='btn btn-info btn-sm' href="<?php echo base_url('mouvement/Formations_stages/add/'.$id_identification)?>"><i class='fa fa-plus'></i>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo base_url('mouvement/Formations_stages/edit/'.$id_identification.'/'.$data->id_formation_stage)?>">
                        <span class="fa fa-edit"></span>
                    </a>

                    <a href="<?php echo base_url('mouvement/Formations_stages/delete/'.$id_identification.'/'.$data->id_formation_stage)?>">
